...
本サービスは13歳以上の方を対象としています。18歳未満の方は保護者と相談のうえご利用ください。

## 9. 子どもの安全に関するポリシー

Tonight? および BEYTH STUDIO は、子どもの安全を最優先に取り組んでいます。以下の行為を厳禁します：

- 児童性的虐待素材（CSAM）の生成、配布、保有
- 子どもを性的に搾取または危険にさらすコンテンツ
- 未成年者の性的搾取や虐待を促進、奨励、または容易にするあらゆる活動
- グルーミングや未成年者との不適切な接触

違反行為を確認した場合は、直ちにアカウントを停止します。確認または疑われる児童搾取の事案は、NCMEC（National Center for Missing & Exploited Children）および関連する法執行機関に報告します。
